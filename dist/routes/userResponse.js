...
exports.userResponseRouter = void 0;
const express_1 = __importDefault(require("express"));
const dotenv_1 = __importDefault(require("dotenv"));
const prisma_1 = require("../utils/prisma");
dotenv_1.default.config();
const userResponseRouter = express_1.default.Router();
exports.userResponseRouter = userResponseRouter;
userResponseRouter.post("/", async (req, res) => {
    try {
        const { scriptLineId, response } = req.body;
        ...
        const scriptLineExists = await prisma_1.prisma.scriptLine.findUnique({
        ...
        const userResponse = await prisma_1.prisma.userResponse.create({
            data: {
                scriptLineId,
                response
            },
...
userResponseRouter.get("/", async (req, res) => {
    try {
        ...
        const userResponses = await prisma_1.prisma.userResponse.findMany({
            include: {
                scriptLine: {
                    select: {
                        id: true,
